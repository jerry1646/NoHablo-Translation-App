...
class AnimatedLoader extends Component {
  ...
  render(){
    return (
    <div className="svg" id="loader" dangerouslySetInnerHTML={
      {__html:
        "<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' version='1.1' id='svg' x='0px' y='0px' width='110px' height='110px' viewBox='0 0 213.235 241.176' enable-background='new 0 0 213.235 241.176' xml:space='preserve' fill='#0057B8'>"+
